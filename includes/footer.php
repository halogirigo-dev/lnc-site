...
<!-- Pre-Footer CTA Zone (inside <main>) -->
<div class="prefooter-cta">
  ...
  <div class="prefooter-cta__actions">
    <a href="/booking" class="btn btn--primary">Plan Your Journey</a>
    <a href="https://wa.me/<?= SITE_WA ?>?text=Hi%20LNC%2C%20I%27d%20like%20to%20enquire%20about%20a%20trip%20to%20Lombok"
    ...
    <div class="footer__grid">
      ...
      <div>
        <div class="footer__logo">
          <img src="<?= UPLOADS_URL ?>/logo-1777215811265.png" alt="<?= SITE_NAME ?> logo" width="40" height="40">
          <div>
        ...
        <nav class="footer__socials" aria-label="Social media links">
          <a href="https://wa.me/<?= SITE_WA ?>" class="footer__social" target="_blank" rel="noopener noreferrer" aria-label="Chat on WhatsApp">WhatsApp</a>
          <a href="https://instagram.com/lomboknatureculture" class="footer__social" target="_blank" rel="noopener noreferrer" aria-label="Follow on Instagram">Instagram</a>
          <a href="https://tripadvisor.com" class="footer__social" target="_blank" rel="noopener noreferrer" aria-label="Read reviews on TripAdvisor">TripAdvisor</a>
        </nav>
      </div>
      <!-- Experiences -->
      <nav aria-label="Experiences">
        <p class="footer__col-title" aria-hidden="true">Experiences</p>
        <a href="/experiences?cat=culture"   class="footer__link">Culture &amp; Heritage</a>
        <a href="/experiences?cat=island"    class="footer__link">Island Escape</a>
        <a href="/experiences?cat=adventure" class="footer__link">Adventure</a>
        <a href="/experiences?cat=honeymoon" class="footer__link">Honeymoon</a>
        <a href="/experiences?cat=long"      class="footer__link">Long Stay</a>
      </nav>
      <!-- Company -->
      <nav aria-label="Company">
        <p class="footer__col-title" aria-hidden="true">Company</p>
        <a href="/team"     class="footer__link">Our Team</a>
        <a href="/hotels"   class="footer__link">Hotel Partners</a>
        <a href="/legal"    class="footer__link">Legal &amp; Policies</a>
        <a href="/booking"  class="footer__link">Book a Journey</a>
        <a href="/invoice"  class="footer__link">Invoice Portal</a>
      </nav>
      <!-- Contact -->
      <div>
        <p class="footer__col-title">Contact</p>
        <a href="mailto:<?= SITE_EMAIL ?>" class="footer__link"><?= SITE_EMAIL ?></a>
        <a href="https://wa.me/<?= SITE_WA ?>" class="footer__link" target="_blank" rel="noopener noreferrer" aria-label="Call or WhatsApp <?= SITE_PHONE ?>"><?= SITE_PHONE ?></a>
...
<div class="mobile-sticky-cta" id="mobile-sticky-cta">
  <a href="/booking">Plan Your Journey &rarr;</a>
</div>
